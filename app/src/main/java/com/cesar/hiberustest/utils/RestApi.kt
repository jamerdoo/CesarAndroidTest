package com.cesar.hiberustest.utils

import android.content.Context
import android.net.ConnectivityManager
import com.cesar.hiberustest.MyApplication
import com.cesar.hiberustest.utils.Consts.RETROFIT.HEADER_CACHE_CONTROL
import com.cesar.hiberustest.utils.Consts.RETROFIT.HEADER_PRAGMA
...
interface RestApi {
    ...
    object ServiceBuilder {
        private val client = OkHttpClient.Builder().readTimeout(60, TimeUnit.SECONDS).addInterceptor(
            offlineCacheInterceptor()).addInterceptor(cacheInterceptor())
        ...
        private fun isConnected(): Boolean {
            try {
                val e = MyApplication.appContext
